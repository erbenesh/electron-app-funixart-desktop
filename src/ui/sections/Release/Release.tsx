...
import { minutesToTime, getSeasonFromUnix } from '../../utils/utils';
...
export const Release = () => {
  ...
  return currentRelease.isPending || !release ? (
            ...
            <div className={styles.release_header}>
              <div className={styles.header_image_borders}>
                <div className={styles.header_background_image_border}>
                  <img
                    className={styles.header_background_title_image}
                    src={release.image}
            ...
            <div className={styles.off_view}>
              <div data-position="top" className={styles.info_carousel}>
                <span className={styles.info_carousel__text}>
                  • Просмотр только на официальном ресурсе • Просмотр только на официальном ресурсе
                  • Просмотр только на официальном ресурсе • Просмотр только на официальном ресурсе
                  • Просмотр только на официальном ресурсе • Просмотр только на официальном ресурсе
                  • Просмотр только на официальном ресурсе • Просмотр только на официальном ресурсе
                  • Просмотр только на официальном ресурсе • Просмотр только на официальном
                </span>
              </div>
            </div>
          )
            ...
            <div className={styles.release_info}>
              <div className={styles.release_info_header}>
                ...
                <div className={styles.release_base_info}>
                  ...
                  <div className={styles.releases_info_buttons}>
                    <div className={styles.info_buttons_wrap}>
                      <div>
                        ...
                        <div
                          className={styles.dropdown_lists}
                          style={isDropdownListsHidden ? { display: 'flex' } : {}}
                        >
                          {lists.map(
                            (li) =>
                              li.name !==
                      ...
                      <button
                        className={
                          release.is_favorite ? styles.info_button_favorite : styles.info_button
                        }
                        onClick={() => addToFavorite()}
                        type="button"
                      >
                        {release.is_favorite ? (
                          <IoBookmark className={styles.comments_b_ico} />
                        ) : (
                          <IoBookmarkOutline className={styles.comments_b_ico} />
                        )}
                    ...
                    <ul className={styles.parameters_icons}>
                      <li className={styles.icon}>
                        <img
                          ...
                          alt=""
                        />
                        {release.country !== 'Япония' && release.country !== 'Китай' && (
                          <LuFlag className={styles.mini_ico} />
                        )}
                      </li>
                      <li className={styles.icon}>
                        <BsCollectionPlay className={styles.mini_ico} />
                      </li>
                      <li className={styles.icon}>
                        <IoCalendarOutline className={styles.mini_ico} />
                      </li>
                      <li className={styles.icon}>
                        <GrGroup className={styles.mini_ico} />
                      </li>
                    </ul>
                  ...
                  {release.vote_count > 0 && <ReleaseVotesCounter release={release} />}
                </div>
              </div>

              <div className={styles.genres_wrap}>
                <p className={styles.genres}>
                  <GoHash className={styles.hash_ico} style={{ width: 1.2 + 'rem' }} />{' '}
                  {release.genres}
                </p>
              </div>
              ...
              <div className={styles.description_wrap}>
                ...
                {textLineCount > 4 && (
                  <button
                    ...
                    onClick={() => setDescriptionHidden(!isDescriptionHidden)}
                  >
              ...
              <div className={styles.screens_wrap}>
                ...
                <div className="carousel">
                  ...
                  <div className={styles.carousel_buttons}>
                    <button
                      className={styles.carousel_prev_button}
                    ...
                    <button
                      className={styles.carousel_next_button}
                      style={
                        currentIndex >= Math.ceil(release.screenshot_images.length / 3) * 2
              ...
              <div className="carousel">
                ...
                <div className={styles.carousel_buttons}>
                  ...
                  <button
                    className={styles.carousel_next_button}
                    style={
                      currentIndex >= Math.ceil(release.video_banners.length / 3) * 2
                        ? { opacity: 0, pointerEvents: 'none' }
                        : {}
                    }
                    onClick={() => goToNextSlide()}
            ...
            <div className={styles.screens_wrap}>
              ...
              <div className={styles.comments_section_wrap}>
                <div className={styles.comments_section}>
                  {currentReleaseComments.data?.map(
                    (comment) => comment.id && <Comment key={comment.id} comment={comment} />
                  )}
                </div>
              </div>
            </div>
