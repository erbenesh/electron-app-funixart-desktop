        ...
        <div>
            ...
            <div className={styles.home_page_wrap}>
                <div className={styles.home_page}>      
                    ...
                    <HomeCarouselx2 array={discoverInteresting.data.content} sectionTitle={"Интересное"} sectionTitleAlt={"interestingReleases"}/>

                    <HomeCarouselx5 array={lastUpdatedReleases.data.content} sectionTitle={"Последнее"} sectionTitleAlt={"lastReleases"} link={"/last-releases"}/>

                    <HomeCarouselx5 array={top.data.content} sectionTitle={"Популярное"} sectionTitleAlt={"topReleases"} link={"/popular"}/>
                    ...
                    <HomeCarouselx5 array={recommendations.data.content} sectionTitle={"Рекомендации"} sectionTitleAlt={"recommendations"} link={"/recommendations"}/>
