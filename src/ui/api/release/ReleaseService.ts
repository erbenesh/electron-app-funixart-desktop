...
import { RELEASE, RELEASE_RANDOM, RELEASE_FILTER } from '../endpoints';
...
class ReleaseService {
  ...
  async getLastUpdatedReleases(status: string, page: string | number = 0, sort: null | number = 0) {
